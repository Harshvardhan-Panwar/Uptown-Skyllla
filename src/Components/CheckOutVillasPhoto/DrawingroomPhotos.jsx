...
import img1 from "../../assets/Drawingroom(1).jpg";
import img2 from "../../assets/Drawingroom(2).jpg";
import img3 from "../../assets/Drawingroom(3).jpg";
import img4 from "../../assets/Drawingroom(4).jpg";
import img5 from "../../assets/Drawingroom(5).jpg";
import img6 from "../../assets/Drawingroom(6).jpg";
import img7 from "../../assets/Drawingroom(7).jpg";


function DrawingroomPhotos() {
  return (
    <>
      <section>
...
export default DrawingroomPhotos;
