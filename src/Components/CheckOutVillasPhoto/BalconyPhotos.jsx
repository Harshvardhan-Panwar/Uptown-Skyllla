...
import img1 from "../../assets/Balcony(1).jpg";
import img2 from "../../assets/Balcony(2).jpg";
import img3 from "../../assets/Balcony(3).jpg";
import img4 from "../../assets/Balcony(4).jpg";
import img5 from "../../assets/Balcony(5).jpg";
import img6 from "../../assets/Balcony(6).jpg";
import img7 from "../../assets/Balcony(7).jpg";


function BalconyPhotos() {
  return (
    <>
      <section>
