...
import img1 from "../../assets/Bedroom(1).jpg";
import img2 from "../../assets/Bedroom(2).jpg";
import img3 from "../../assets/Bedroom(3).jpg";
import img4 from "../../assets/Bedroom(4).jpg";
import img5 from "../../assets/Bedroom(5).jpg";
import img6 from "../../assets/Bedroom(6).jpg";
import img7 from "../../assets/Bedroom(7).jpg";


function BedroomPhotos() {
  return (
    <>
      <section>
